...
public abstract class DefaultNodeVisitor<TResult> : INodeVisitor<TResult>
{
    ...
    public TResult Visit(INode node)
    {
    ...
    public virtual TResult VisitStringLiteral(TextLiteral node)
    {
        return default;
    }
    ...
    public virtual TResult VisitVariableReference(VariableReference node)
    {
        return default;
    }

    public TResult VisitDateLiteral(DateLiteral node)
    {
        return default;
    }

    public TResult VisitTimeLiteral(TimeLiteral node)
    {
        return default;
    }

    public TResult VisitTimestampLiteral(TimestampLiteral node)
    {
        return default;
    }
}
